        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PackagePriceForMarketer = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TravelPackages_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BunnyLibraryId = table.Column<long>(type: "bigint", nullable: true),
                    BunnyVideoId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MarketerPackages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MarketerPackages_AspNetUsers_MarketerId",
                        column: x => x.MarketerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MarketerPackages_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderDetails_TravelPackages_TravelPackageId",
                        column: x => x.TravelPackageId,
                        principalTable: "TravelPackages",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MarketerPackages_MarketerId",
                table: "MarketerPackages",
                column: "MarketerId");

            migrationBuilder.CreateIndex(
                name: "IX_MarketerPackages_ProductId",
                table: "MarketerPackages",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_TravelPackageId",
                table: "OrderDetails",
                column: "TravelPackageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TravelPackages_CompanyId",
